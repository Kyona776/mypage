...
// const {Burst} = dynamic(() => import('@mojs/core'), {ssr: false});
import {} from 'https://unpkg.com/@mojs/core@1.3.0/dist/mo.umd.js';
...
// import mojs from 'https://cdnjs.cloudflare.com/ajax/libs/mo-js/0.288.2/mo.js';
/**
 * Usage:
...
const MojsExample = ({ duration }) => {
  ...
  const clickHandler = useCallback(() => {
    ...
    if (undefined === bouncyCircle.current) return;
